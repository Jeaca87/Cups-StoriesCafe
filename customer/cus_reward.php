...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/cus_reward.css">
    ...
    <div class="section">
      ...
      <div class="rewards-section">
        ...
        <div class="reward-item">
          <p><i class="fas fa-ticket-alt"></i> 5% discount - Any item <small>Valid until Jan 31, 2025</small></p>
          <button type="submit" class="points">10 points</button>
        </div>
        <div class="reward-item">
          <p><i class="fas fa-ticket-alt"></i> 5% discount - Frappe <small>Valid until Jan 31, 2025</small></p>
          <button type="submit" class="points">10 points</button>
        </div>
      </div>
      ...
      <div class="history-section">
        ...
        <div class="history-item">
          <p>Jan 3, 2025 - 5% discount <span>8:00 PM</span></p>
        </div>
      </div>
    </div>
